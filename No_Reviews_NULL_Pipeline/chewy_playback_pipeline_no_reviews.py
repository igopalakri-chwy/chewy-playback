...
Provide realistic scores (0.0-1.0) based on confidence in the inference."""
    ...
    def _get_default_insights(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "Birthday": "unknown",
            "BirthdayScore": 0.0,
            "PersonalityTraits": ["friendly", "loving"],
            "PersonalityScores": {"friendly": 0.7, "loving": 0.8},
            "FavoriteProductCategories": ["food", "treats"],
            "CategoryScores": {"food": 0.8, "treats": 0.7},
            "BrandPreferences": ["Chewy"],
            "BrandScores": {"Chewy": 0.9},
            "DietaryPreferences": ["standard"],
            "DietaryScores": {"standard": 0.6},
            "BehavioralCues": ["enjoys food"],
            "BehavioralScores": {"enjoys food": 0.8},
            "HealthMentions": ["healthy"],
            "HealthScores": {"healthy": 0.7},
            "MostOrderedProducts": ["Pet Food", "Treats"]
        }
        ...
        for customer_id in customers_to_process:
            try:
                ...
                pet_insight = {
                    ...
                    "PersonalityScores": insights.get("PersonalityScores", {"friendly": 0.7}),
                    "FavoriteProductCategories": insights.get("FavoriteProductCategories", ["food"]),
                    "CategoryScores": insights.get("CategoryScores", {"food": 0.8}),
                    "BrandPreferences": insights.get("BrandPreferences", ["Chewy"]),
                    "BrandScores": insights.get("BrandScores", {"Chewy": 0.9}),
                    "DietaryPreferences": insights.get("DietaryPreferences", ["standard"]),
                    "DietaryScores": insights.get("DietaryScores", {"standard": 0.6}),
                    "BehavioralCues": insights.get("BehavioralCues", ["enjoys food"]),
                    "BehavioralScores": insights.get("BehavioralScores", {"enjoys food": 0.8}),
                    "HealthMentions": insights.get("HealthMentions", ["healthy"]),
                    "HealthScores": insights.get("HealthScores", {"healthy": 0.7}),
                    "MostOrderedProducts": insights.get("MostOrderedProducts", ["Pet Food"])
                }
...
class ChewyPlaybackPipelineNoReviews:
    ...
    def preprocess_data(self):
        ...
        if not os.path.exists(preprocessed_order_path):
            ...
            import shutil
            original_path = self.data_dir / "order_history.csv"
